...
TEST_F(LuaSDL2_Test, TestSDLConstants) {
  ...
  TEST_LUA_CONSTANT("opengl", "ARRAY_BUFFER", GL_ARRAY_BUFFER);
  TEST_LUA_CONSTANT("opengl", "STATIC_DRAW", GL_STATIC_DRAW);
  ...
  TEST_LUA_CONSTANT("opengl", "TEXTURE_2D", GL_TEXTURE_2D);
  TEST_LUA_CONSTANT("opengl", "COMPILE_STATUS", GL_COMPILE_STATUS);
  TEST_LUA_CONSTANT("opengl", "LINK_STATUS", GL_LINK_STATUS);

  TEST_LUA_CONSTANT("opengl", "VERTEX_SHADER", GL_VERTEX_SHADER);
  TEST_LUA_CONSTANT("opengl", "FRAGMENT_SHADER", GL_FRAGMENT_SHADER);
}
