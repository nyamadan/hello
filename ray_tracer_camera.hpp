...
class RayTracerCamera {
  ...
  public:
    ...
    glm::vec3 getRayDirEquirectangular(float x, float y, int32_t width, int32_t height) const;
    ...
    void setIsEquirectangula(bool isEquirectangula) { this->isEquirectangula = isEquirectangula; }
